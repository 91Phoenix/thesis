...
public class DescriptionModeratedEvent extends DescriptionModeratorEvent {
	...
	public DescriptionModeratedEvent(){}

	public DescriptionModeratedEvent(ModerationState state,String recipeEntityId){
		this.setState(state);
